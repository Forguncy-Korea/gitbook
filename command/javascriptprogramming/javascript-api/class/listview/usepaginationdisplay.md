...
#### 메서드 <a href="#usepaginationdisplay-fang-fa-fang-fa" id="usepaginationdisplay-fang-fa-fang-fa"></a>

&#x20;  ListView.usePaginationDisplay(pageRowCount, pageIndex)

#### 설명 <a href="#usepaginationdisplay-fang-fa-miao-shu" id="usepaginationdisplay-fang-fa-miao-shu"></a>

이 메서드를 사용 하 여 리스트뷰에 데이터를 페이징 하 고 페이지 당 표시할 행 수를 설정 하 고 지정 된 페이지 번호로 이동할 수 있습니다.

#### **매개 변수**  <a href="#usepaginationdisplay-fang-fa-can-shu-shuo-ming" id="usepaginationdisplay-fang-fa-can-shu-shuo-ming"></a>
...
#### &#x20;**반환값**  <a href="#usepaginationdisplay-fang-fa-fan-hui-zhi" id="usepaginationdisplay-fang-fa-fan-hui-zhi"></a>

없음&#x20;

#### 예제 <a href="#usepaginationdisplay-fang-fa-shi-li" id="usepaginationdisplay-fang-fa-shi-li"></a>
...
#### 사용 예제 <a href="#usepaginationdisplay-fang-fa-shi-li" id="usepaginationdisplay-fang-fa-shi-li"></a>
