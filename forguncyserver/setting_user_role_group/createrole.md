...
2. &#x20;팝업 멤버 편집 대화 상자에서 사용자 인증 모드를 선택하고 검색 상자에 검색 키워드를 입력하고 Enter 키를 클릭하거나 눌러 검색하거나 사용자를 직접 선택할 수 있습니다.![](https://help.grapecity.com.cn/download/thumbnails/72356663/image2018-2-7_11-52-55.png?version=1\&modificationDate=1648092595000\&api=v2)<br>
...
&#x20;역할의 권한 관계에서 현재 역할의 역할 권한을 조회/설정할 수 있으며 현재 역할 권한을 가진 역할이 나열됩니다.&#x20;

#### 다음 역할 권한을 가집니다.&#x20;

&#x20; ![](<../../.gitbook/assets/image (1984).png>)버튼을 클릭 한 후 , 팝업 역할 설정 창에서 역할을 선택합니다. 이는 현재 역할이 선택한 역할의 권한을 가짐을 의미합니다.&#x20;

<figure><img src="../../.gitbook/assets/image (1430).png" alt=""><figcaption></figcaption></figure>

**역할 권한 관계 다이어 그램**&#x20;

역할을 선택한 후 역할의 권한 관계에서 역할의 권한 관계 다이어그램을 볼 수 있으며 어떤 역할이 현재 역할의 권한을 가지고 있는지, 현재 역할이 어떤 권한을 가지고 있는지 확인할 수 있습니다.

<figure><img src="../../.gitbook/assets/image (2221).png" alt=""><figcaption></figcaption></figure>

### 조직 노드&#x20;

역할은 조직 노드 추가를 지원하여 조직 노드의 구성원이 이 역할에 속함을 나타냅니다. 조직 노드를 선택할 때 이 노드의 구성원 또는 이 노드 및 해당 하위 노드의 모든 구성원을 선택할 수 있습니다.

역할 선택 후 오른쪽 기본 정보의 조직 노드 영역에서 조직 노드 수정을 클릭합니다.
