...
1. 데이터 테이블을 열고 테이블 설정에서 데이터 추가/생성 권한 편집을 체크한 후 \[권한 편집..]을 클릭합니다.

<figure><img src="../../.gitbook/assets/image (2551).png" alt=""><figcaption></figcaption></figure>

2. &#x20;승인된 사용자를 설정하세요. 역할 열을 클릭하면 팝업 역할 목록에서 레코드 생성 권한을 부여하는 역할을 선택할 수 있습니다. 예를 들어 "로그인한 사용자"를 선택합니다.
...
4. &#x20;설정이 완료되면 페이지를 실행하고 사용자 유재석을 사용하여 로그인하고 로그인 한 후 새 데이터를 추가합니다.
