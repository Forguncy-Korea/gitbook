...
1. 다음 그림과 같이 페이지에 주문 테이블과 일부 필드를 바인딩합니다.
2. &#x20;OData 수식을 사용하여 주문 테이블에 제품 테이블의 제품 이름을 표시합니다.

리스트뷰 행의 \[제품 이름] 아래의 셀을 클릭하고 리본 메뉴 모음에서 \[수식->OData 생성기]를 선택합니다.

![](../../.gitbook/assets/OData20.png)

3. OData 생성기에서 테이블을 제품 테이블로 선택하고 선택 탭에서 열을 선택하고, 구매항목을 선택합니다.

![](../../.gitbook/assets/Odata21.png)

4. 쿼리 조건을 설정합니다. \[쿼리] 탭에서 \[새 조건]을 클릭합니다.

![](../../.gitbook/assets/Odata22.png)

5. \[확인]을 클릭하여 OData 생성기를 닫고 Enter 키를 눌러 OData 수식을 커밋합니다.
6. &#x20;브라우저에서 볼 수 있듯이 주문 목록에 제품 이름 표시되는 페이지를 실행합니다.
