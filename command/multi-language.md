...
포건시는 다국어 설정을 지원하며 페이지의 텍스트를 다른 언어로 전환할 수 있습니다.&#x20;

### 다국어 활성화 <a href="#kai-qi-duo-yu-yan" id="kai-qi-duo-yu-yan"></a>
...
다중 언어를 활성화한 후 언어를 편집하고 설정할 수 있습니다.
...
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 언어 이름 | 언어 이름을 설정합니다.                                                                                                                                                                    |
| 언어 속성 | <p>언어 속성을 설정합니다.</p><p>즉, en-US와 같은 BCP-47 언어 태그는 해당 언어가 영어(en)임을 나타내고, 지정된 국가나 지역이 미국(US)이라는 것을 나타내므로 미국식 영어를 나타내는 데 사용된다. 이는 브라우저와 검색 엔진이 페이지의 언어를 올바르게 구문 분석하는 데 도움이 됩니다.</p> |
| 폰트    | 글꼴을 설정합니다. 드롭다운 버튼을 클릭하여 글꼴을 선택하세요.                                                                                                                                              |
| 설명    | 언어 설명 정보를 설정합니다.                                                                                                                                                                 |
...
"리소스"를 클릭하면 다음 대화 상자가 나타납니다. 여기에서 애플리케이션 리소스, 시스템 리소스, 플러그인 리소스를 관리할 수 있습니다.
...
오류 메시지, 프롬프트 메시지 등 포건시에 내장된 리소스
...
명령 대기, 리치 텍스트 편집기 등 프로젝트에서 사용되는 플러그인의 리소스입니다.
...
런타임 시 시스템이 표시하는 언어를 전환하려면 "런타임 언어 전환 명령"을 사용하십시오.
