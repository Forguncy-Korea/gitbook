...
<table><thead><tr><th width="186.8">계정 로그인</th><th>파일 위치</th></tr></thead><tbody><tr><td>로컬 시스템 계정 (기본값)</td><td>C:\Windows\Temp\포건시 작업 로그</td></tr><tr><td>특정 사용자 계정 </td><td>C:\Users&#x3C; 사용자 계정 이름>\AppData\Local\Temp\포건시 작업 로그</td></tr></tbody></table>
