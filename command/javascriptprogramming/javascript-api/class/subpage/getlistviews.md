...
#### 사용 예제 <a href="#getlistviews-fang-fa-shi-li" id="getlistviews-fang-fa-shi-li"></a>

1. 페이지 1에 여러 테이블을 바인딩합니다.
...
3. 페이지 2에서 셀 범위를 선택하고, 셀 유형을 버튼으로 설정하고, 명령을 \[자바스크립트로 직접 프로그래밍하기]으로 편집하고, JavaScript 코드를 입력합니다.
