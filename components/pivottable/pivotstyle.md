...
1. 피벗 테이블을 선택합니다.리본 메뉴 모음에서 \[셀 스타일]을 클릭합니다.。
2. &#x20;기본 제공 셀 스타일 목록에서 새 셀 스타일을 클릭하여 셀 그리드 스타일 지정 대화 상자를 팝업합니다.

![](../../.gitbook/assets/pivots2.png)

3. &#x20;\[이름] 뒤에 있는 텍스트 상자에 스타일의 이름을 입력합니다.
4. &#x20;스타일을 지정합니다. 배경색, 전경색 및 테두리를 설정합니다. 아래 미리 보기 영역에서 요소 스타일 효과를 볼 수 있습니다.
5. &#x20;\[확인]을 클릭하여 사용자 스타일을 저장합니다. 셀 스타일을 클릭하면 셀 스타일 목록 맨 위에 사용자 지정 스타일이 나열됩니다.
