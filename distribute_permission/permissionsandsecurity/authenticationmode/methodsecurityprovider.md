...
1. Visual Studio에서 클래스 라이브러리 프로젝트를 만듭니다. 프로젝트의 Framework를 .NET Framework 4.7.2로 설정합니다

<figure><img src="../../../.gitbook/assets/image (585).png" alt=""><figcaption></figcaption></figure>

2. &#x20;솔루션 탐색기에서 참조를 마우스 오른쪽 버튼으로 클릭하고 참조 추가를 선택합니다.

<figure><img src="../../../.gitbook/assets/image (2040).png" alt=""><figcaption></figcaption></figure>



3. &#x20;오른쪽 하단의 "찾아보기"를 클릭하고 Mosaic의 설치 디렉토리에서 "GrapeCity.Forguncy.SecurityProvider.dll" 파일을 찾아 프로젝트에 대한 참조로 추가합니다.
...
4. &#x20;" GrapeCity.Forguncy.SecurityProvider.dll " 파일을 선택하고 마우스 오른쪽 버튼을 클릭하고 "속성"을 선택한 다음 "로컬복사"를 "False"로 변경합니다.

<figure><img src="../../../.gitbook/assets/image (872).png" alt=""><figcaption></figcaption></figure>

5. Class1.cs 파일에 코드를 추가합니다. 샘플 코드는 다음과 같습니다.
...
6. &#x20;코드가 추가된 후 이름을 마우스 오른쪽 버튼으로 클릭하고 "Generate" 또는 "Regenerate"를 선택하여 컴파일합니다.
7. &#x20; 컴파일이 완료되면 파일 탐색기에서 폴더를 열고 생성된 모든 파일을 "bin/Debug" 또는 "bin/Release" 폴더 아래의 .zip 파일로 압축합니다.

<figure><img src="../../../.gitbook/assets/image (659).png" alt=""><figcaption></figcaption></figure>

8. &#x20; 서버관리자에서사용자 계정 관리 인터페이스의 "타사" 영역에서 "업로드"를 클릭하고 security provider.zip 패키지 파일을 선택합니다
9. 포건시 디자이너에서 인증 모드를 "타사 사용자 통합"으로 선택하면 게시 후 맞춤형 사용자 보안 프로그램을 실현할 수 있습니다.
